...
<div class="container show-class-container">
    <div class="row show-class-main-row">
        <div class="col-md-2 col-sm-2" style="max-width:10%;">
        ...
        <div class="col-md-2 md-2-col col-sm-2">
            <button class="btn btn-md btn-success pull-right" style="background-color: #38ADA9; margin:44px -57px 0px 0px"><a href="{{url('/start-session/'.$class->id)}}" style=" color:#fff; text-decoration:none">&nbsp;Join</a></button>
        </div>
    </div>
</div>
<br>
