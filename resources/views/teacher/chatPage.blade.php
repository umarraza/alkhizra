    ...
    messageRef.on('child_added',function(snapshot){
        ...
        if (message.classId == class_id) {
            ...
            if (message.roleId == 2) {
                ...
                // <div class="student-message">Umar Raza: Hello students?</div>
                

                var element = document.createElement('div');

                element.className = `teacher-message`;
                element.style.cssText = "width:400px;height:30px; background:#EBEDEF;margin:5px 0 5px 0;border-radius: 10px 40px 30px;"
                ...
                element2.style.cssText = "width:400px;height:30px; background:#F6DDCC;margin:5px 0 5px 200px;border-radius: 10px 40px 30px;"
