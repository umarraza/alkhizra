...
<script src="theme/js/jquery.easyui.min.js" defer></script>
<script src="theme/js/fabric-min.js" defer></script>
<script src="theme/js/screenfull.js" defer></script>
<script src="theme/js/ion.sound.min.js" defer></script>
<script src="theme/js/rmc3.min.js" defer></script>
<script src="theme/js/rmc3.fbr.min.js" defer></script>
<script src="theme/js/socket.io.js" defer></script>
<script type="text/javascript" src="theme/js/slick.min.js" defer></script>
<script type="text/javascript" src="tutor_connect/js/bootstrap.min.js" defer></script>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>


<!-- Firebase & Whiteboard Scripts -->
<script src="https://www.gstatic.com/firebasejs/6.3.1/firebase-app.js" defer></script>
<script src="https://www.gstatic.com/firebasejs/6.3.0/firebase-auth.js" defer></script>
<script src="https://www.gstatic.com/firebasejs/6.3.0/firebase-firestore.js" defer></script>
<script src="https://www.gstatic.com/firebasejs/6.3.1/firebase-database.js" defer></script>
<script src="https://cdn.firebase.com/js/client/2.3.2/firebase.js" defer></script>
<script src="{{ asset('/public/js/tutorialspoint.js') }}" defer></script>
<script src="{{ asset('/public/js/whiteboard.js') }}" defer></script>
<script src="theme/js/lightslider.js" defer></script>
<script src="https://www.google-analytics.com/urchin.js" defer></script>
